...
public class FiveCardHandEvaluator implements HandEvaluator {
    ...
    private HandRanking rankHand(List<Poker> cards)
     ...
     */
    private void orderCards(List<Poker> cards, HandRanking ranking)
    {
    ...
    private int findPair(List<Poker> cards)
    {
     ...
     * card in the hand.
     */
    private int countPairs(List<Poker> cards)
    {
        int pairs = 0;
        int runLength = 1;
        for (int i = 0; i < cards.size() - 1; i++)
     ...
     */
    private boolean isFlush(List<Poker> cards)
    {
     ...
     */
    private boolean isStraight(List<Poker> cards)
    {
        if (cards.size() != RankedHand.HAND_SIZE)
        {
            return false;
